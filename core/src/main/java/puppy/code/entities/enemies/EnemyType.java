...
public enum EnemyType {
    METEORITE("Game/Enemys/Asteroids/Asteroid.atlas", 20, 1, 10, 5, "explosion.ogg"),
    ROKU("Game/Enemys/EnemyShips/Roku.png", 48, 10, 75, 15, "explosion.ogg"),
    CHARGER("Game/Enemys/EnemyShips/Charger.png", 48, 15, 50, 15, "explosion.ogg");
